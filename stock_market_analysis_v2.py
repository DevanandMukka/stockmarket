...
st.markdown("<div style='text-align: center; color: #16a34a; font-size:32px; font-weight:600; margin-bottom:18px;'>Plan the trade ; Trade the plan</div>", unsafe_allow_html=True)
